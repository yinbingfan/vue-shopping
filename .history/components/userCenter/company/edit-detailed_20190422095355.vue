      ...
      <el-row :gutter="26">
        <el-col :span="8">
          ...
          <el-form-item label="公司性质" prop="">
            <el-select @change="selectCompanyType(value,label)" v-model="agentDetailInfo.companyType">
              <el-option
        ...
        <el-col :span="8">
          ...
          <el-form-item label="联系人电话" prop="secondContactTel">
            <el-input
              v-model.trim="agentDetailInfo.secondContactTel" placeholder="联系人电话"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
    </el-form>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      closeImg(key) {
        this.agentDetailInfo.attachments[key]={}
