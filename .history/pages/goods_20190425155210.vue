  ...
  export default {
    ...
    methods: {
      ...
      handlerChangePage(pages) {
        ...
        this.defaultQueryParams = { ...this.defaultQueryParams, ...pageQueryParams }
        this.getSendGoodsList()
      },
      ...
      setSmallV(desc, code) {
        ...
        this.defaultQueryParams = { ...this.defaultQueryParams, ...smallQueryParams }
        this.getSendGoodsList()
      },
      changePrice(val) {
        ...
        this.defaultQueryParams = { ...this.defaultQueryParams, ...priceQueryParams }
        this.getSendGoodsList()
      },
      handleScroll() {
